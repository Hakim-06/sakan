...
const buildVerifyEmailHtml = (name, code) => `
  <div style="margin:0;padding:24px 0;background:#f8fafc;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
    <div style="max-width:520px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;padding:22px;">
      <h2 style="margin:0 0 8px;font-size:20px;">Verification de ton compte</h2>
      <p style="margin:0 0 12px;font-size:14px;color:#475569;">Bonjour ${name || ''}, entre ce code dans l'application SakanCampus.</p>
      <div style="background:#fff7ed;border:1px solid #fdba74;border-radius:10px;padding:14px;text-align:center;margin:0 0 12px;">
        <div style="font-size:30px;font-weight:800;letter-spacing:6px;color:#9a3412;">${code}</div>
      </div>
      <p style="margin:0 0 6px;font-size:13px;color:#334155;">Ce code expire dans 10 minutes.</p>
      <p style="margin:0;font-size:12px;color:#94a3b8;">Si tu n'es pas a l'origine de cette action, ignore cet email.</p>
    </div>
  </div>
`;
...
const buildResetPasswordHtml = (name, code) => `
  <div style="margin:0;padding:24px 0;background:#f8fafc;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
    <div style="max-width:520px;margin:0 auto;background:#ffffff;border:1px solid #e2e8f0;border-radius:12px;padding:22px;">
      <h2 style="margin:0 0 8px;font-size:20px;">Code de reinitialisation</h2>
      <p style="margin:0 0 12px;font-size:14px;color:#475569;">Bonjour ${name || ''}, utilise ce code pour changer ton mot de passe.</p>
      <div style="background:#eff6ff;border:1px solid #93c5fd;border-radius:10px;padding:14px;text-align:center;margin:0 0 12px;">
        <div style="font-size:30px;font-weight:800;letter-spacing:6px;color:#1d4ed8;">${code}</div>
      </div>
      <p style="margin:0 0 6px;font-size:13px;color:#334155;">Ce code expire dans 10 minutes.</p>
      <p style="margin:0;font-size:12px;color:#94a3b8;">Si tu n'es pas a l'origine de cette demande, ignore cet email.</p>
    </div>
  </div>
`;
